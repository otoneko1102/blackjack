const descriptions = {
  ...
  jp: `
    <h2>ブラックジャック</h2>
    <p>
      <strong>ブラックジャック</strong>は、プレイヤーとディーラーの間でプレイされるカードゲームです。21点を超えないように21点に近づけ、点数が高い側が勝利します。
    </p>

    <h3>ゲームプレイ</h3>
    <p>最初に2枚のカードを配られ、その後に<strong>ヒット</strong>または<strong>スタンド</strong>という動作を行えます。</p>

    <h3>用語の解説</h3>
    <p>
      <strong>ヒット：</strong> ディーラーからもう1枚のカードを要求して合計値を増やすこと。<br>
